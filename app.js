...
function renderClassificacao(ronda) {
    if (!isAdmin()) {
        document.getElementById('classificacaoContainer').innerHTML = '<p style="text-align:center;padding:2rem;">Apenas administradores podem ver a classificação.</p>';
        return;
    }
    ...
    Object.keys(standings).sort().forEach(grupo => {
        ...
        <div class="class-group">
            ...
            <div class="class-controls">
                <p class="class-desc">Registar resultados para actualizar a classificação:</p>
            </div>
        ...
        html += `
            ...
            <div class="games-input" style="margin-top:1.5rem;">
                <h4 style="margin-bottom:0.75rem; color:var(--primary);">Resultados dos Jogos:</h4>
        `;
    ...
    // Adicionar listeners aos botões de resultado
